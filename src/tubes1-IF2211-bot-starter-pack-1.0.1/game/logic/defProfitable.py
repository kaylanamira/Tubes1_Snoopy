...
class DefensiveProfit(BaseLogic):
    def __init__(self):
    ...
    def next_move(self, board_bot: GameObject, board: Board) -> Tuple[int, int]:
        ...
        print("Goal position: ", self.goal_position, end="\n")
        print("---------------------------------------------")
        ...
        print("Enemy coordinate: ", enemies_coordinate, end="\n")
        print("---------------------------------------------")
        ...
        print("Dangerous coordinate: ", self.dangerous_coordinate, end="\n")
        print("---------------------------------------------")

        threat = list(filter(lambda x: x in enemies_coordinate, self.dangerous_coordinate))
        print("Threat coordinate: ", threat, end="\n")
        print("---------------------------------------------")
        if len(threat) != 0:
