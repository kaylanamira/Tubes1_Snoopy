...
@dataclass
class Properties: #diamond, bot, teleporter, base
...
class Board:
    ...
    @property
    def bots(self) -> List[GameObject]: # list berisi semua bot di board
        return [d for d in self.game_objects if d.type == "BotGameObject"]

    @property
    def diamonds(self) -> List[GameObject]: # list berisi semua diamond di board
